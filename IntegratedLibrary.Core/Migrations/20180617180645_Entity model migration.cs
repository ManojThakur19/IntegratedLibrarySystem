...
{
    public partial class Entitymodelmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchHourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BranchHourses_LibraryBranchs_LibraryBranchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LibraryAssets_LibraryBranchs_LibraryBranchId",
                        column: x => x.LibraryBranchId,
                        principalTable: "LibraryBranchs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchHourses_LibraryBranchId",
                table: "BranchHourses",
